...
window.SCENE_DESIGN = {
  ...
  stations: [
    ...
    {id:'bedA',name:'臥室 A',x:178,z:338,heading:35},
    {id:'bedB',name:'臥室 B',x:550,z:255,heading:345},
    {id:'bedC',name:'臥室 C',x:466,z:740,heading:250},
  ...
  circuits: [
    ...
    {id:'dining',name:'餐廳',kind:'pendant',label:'餐桌吊燈',color:0xffd5a0,points:[[576,500]],power:21000},
